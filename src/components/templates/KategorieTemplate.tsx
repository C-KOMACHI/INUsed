            ...
            <Grid container mt={3}>
                <Grid item xs={4}>
                    <Stack
                        ...
                        mb={3}
                        onClick={() => {
                            push('KategorieSub', { id: 1, title: '남성 의류' });
                        }}
                    >
                ...
                <Grid item xs={4}>
                    <Stack
                        ...
                        mb={3}
                        onClick={() => {
                            push('KategorieSub', { id: 2, title: '여성 의류' });
                        }}
                    >
                ...
                <Grid item xs={4}>
                    <Stack
                        ...
                        mb={3}
                        onClick={() => {
                            push('KategorieSub', { id: 3, title: '뷰티&미용' });
                        }}
                    >
                ...
                <Grid item xs={4}>
                    <Stack
                        ...
                        mb={3}
                        onClick={() => {
                            push('KategorieSub', { id: 4, title: '도서' });
                        }}
                    >
                ...
                <Grid item xs={4}>
                    <Stack
                        ...
                        mb={3}
                        onClick={() => {
                            push('KategorieSub', { id: 5, title: '패션잡화' });
                        }}
                    >
                ...
                <Grid item xs={4}>
                    <Stack
                        ...
                        mb={3}
                        onClick={() => {
                            push('KategorieSub', { id: 6, title: '티켓&교환권' });
                        }}
                    >
                ...
                <Grid item xs={4}>
                    <Stack
                        ...
                        mb={3}
                        onClick={() => {
                            push('KategorieSub', { id: 7, title: '가구&인테리어' });
                        }}
                    >
                ...
                <Grid item xs={4}>
                    <Stack
                        ...
                        mb={3}
                        onClick={() => {
                            push('KategorieSub', { id: 8, title: '디지털 기기' });
                        }}
                    >
                ...
                <Grid item xs={4}>
                    <Stack
                        ...
                        mb={3}
                        onClick={() => {
                            push('KategorieSub', { id: 9, title: '생활 가전' });
                        }}
                    >
                ...
                <Grid item xs={4}>
                    <Stack
                        ...
                        mb={3}
                        onClick={() => {
                            push('KategorieSub', { id: 10, title: '스포츠&레저' });
                        }}
                    >
                ...
                <Grid item xs={4}>
                    <Stack
                        ...
                        mb={3}
                        onClick={() => {
                            push('KategorieSub', { id: 11, title: '취미&게임&음반' });
                        }}
                    >
                ...
                <Grid item xs={4}>
                    <Stack
                        ...
                        mb={3}
                        onClick={() => {
                            push('KategorieSub', { id: 12, title: '가공 식품' });
                        }}
                    >
                ...
                <Grid item xs={4}>
                    <Stack
                        ...
                        mb={3}
                        onClick={() => {
                            push('KategorieSub', { id: 13, title: '식물' });
                        }}
                    >
                ...
                <Grid item xs={4}>
                    <Stack
                        ...
                        mb={3}
                        onClick={() => {
                            push('KategorieSub', { id: 14, title: '반려동물 용품' });
                        }}
                    >
                ...
                <Grid item xs={4}>
                    <Stack
                        ...
                        mb={3}
                        onClick={() => {
                            push('KategorieSub', { id: 15, title: '기타' });
                        }}
                    >
