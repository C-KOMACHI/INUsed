...
export const WriterTemplate: FC = () => {
    return <AppScreen header borderRadius title='상품 등록'>
        <Stack sx={{pt:2.5, px: 1, pb: 2}} spacing={2}>
            <Box alignItems="center" justifyContent="center" display="flex" sx={{width: '60px', height: '60px', border: '1px solid gray', borderRadius: 4,}}>
